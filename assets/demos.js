document.addEventListener('DOMContentLoaded', function () {
  ...
  new Typed('#typed6', {
    strings: convertArrayToFormattedString(["It’s one of the paradoxes of love that we can from the outside immediately see something that it can take us a lifetime to unravel in ourselves: people pick hugely inappropriate partners.",
...
function convertArrayToFormattedString(array) {
  const result = array.map(function (str) {
