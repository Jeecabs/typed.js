	  ...
	  _createClass(Typed, [{
	    ...
	    value: function begin() {
	      ...
	      this.timeout = setTimeout(function () {
	        ...
	        if (_this.strPos === 0) {
	          ...
	          _this.backspace(_this.strings[_this.sequence[_this.arrayPos]], _this.strPos);
	        }
	      }, this.startDelay);
	    }
	    ...
	    value: function typewrite(curString, curStrPos) {
	      ...
	      this.timeout = setTimeout(function () {
	        ...
	        var pauseTime = 0;
	        var substr = curString.substring(curStrPos);
	    ...
	    value: function keepTyping(curString, curStrPos, numChars) {
	      ...
	      curStrPos += numChars;
	      var nextString = curString.substring(0, curStrPos);
	    ...
	    value: function backspace(curString, curStrPos) {
	      ...
	      this.timeout = setTimeout(function () {
	        ...
	        var curStringAtPosition = curString.substring(0, curStrPos);
